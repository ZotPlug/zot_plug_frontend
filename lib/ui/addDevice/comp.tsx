				...
				<View style={styles.modalContainer}>
					<View style={styles.modalCardContainer}>
						...
						<View style={styles.buttonContainer}>
							...
							<BasicButton text={"Submit"} onPress={() => onSubmit({ deviceName: textInput })} />
						</View>
					</View>
				</View>
			</Modal>
...
const styles = StyleSheet.create({
	...
	modalBody: {
		...
		alignItems: 'flex-start',
		width: '100%',
		paddingHorizontal: 12       // optional, looks cleaner
	},
	buttonContainer: {
		flexDirection: 'row',
		width: '50%'
	...
	textStyle: {
		paddingBottom: 6,
		fontWeight: 'bold', // Or '700', '800', '900' for different levels of boldness
	},
